const TEAM_PIN = "1234"; 
const URL_API_POSTBACK = "https://script.google.com/macros/s/AKfycbyaRf32Lw2zFyELiG5skQyxjzs_olNa7N_QjyVsKWR2elL6goLKlcIxejTGeMzmy85T/exec"; 
...
// ==========================================
// 1. LOGIKA LOGIN (VIDEO INTRO DIHAPUS)
// ==========================================
document.addEventListener("DOMContentLoaded", () => {
    const loginOverlay = document.getElementById('login-overlay');
    const savedPin = sessionStorage.getItem("lupo_pin");

    // Langsung tampilkan layar login tanpa menunggu apa pun
    if (loginOverlay) {
...
function showPage(pageId, btnElement) {
  if(autoRefreshInterval) clearInterval(autoRefreshInterval);
    ...
    // Setelah pindah halaman, baru jalankan lagi refresh
    setTimeout(() => {
        if(autoRefreshInterval) clearInterval(autoRefreshInterval);
...
// ==========================================
// 6. TOOLS MEDIA & LINKS (MEMBER LAMA KEMBALI)
// ==========================================
...
// ==========================================
// 7. FOLDER VIDEO LOGIC (SAMA SEPERTI AWAL)
// ==========================================
const vidsData = {
...
function openVideo(id, judul) {
    ...
    if(folderView && listView && renderArea) {
        ...
        // Render satu per satu dengan lebih ringan
...
// PASTIKAN FUNGSI INI ADA DI PALING BAWAH FILE
